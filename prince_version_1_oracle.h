#include<stdio.h>
long circ_shift(long x,int pos){			/* circular shifting (in 64-bit) right side by 'pos' position */
	return ((x>>pos)|(x<<(64-pos)));
	}

int sb_table[16] = {0xb,0xf,0x3,0x2,0xa,0xc,0x9,0x1,0x6,0x7,0x8,0x0,0xe,0x5,0xd,0x4};	/* the subbyte table */
...
//	Algebraic Normal Form of sbox: x0*x1 + x0*x2 + x0*x3 + x1*x2*x3 + x1*x3 + x2*x3 + x2 + x3
